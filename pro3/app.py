...
Requires: pip install flask qrcode[pil] python-dotenv
...
# This means SAFE_BROWSING_API_KEY only needs to be set once, ever - it
# survives closing the terminal, unlike a plain `set`/`export` command.
load_dotenv()
